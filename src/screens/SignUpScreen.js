...
const SignUpSchema = yup.object({
  ...
  confirmPassword:yup.string().required("please confirm your password") .when('password', (password, schema) => {
    return schema.test({
...
export default function SignUpScreen({navigation}) {
  ...
  return (
    <ScrollView style={styles.authContainer}>
      ...
      <UserIcon height={20} width={20}style={{marginRight:"5%",color:"#BDBDBD"}} />
      <TextInput
      ...
      {props.touched.fullName && props.errors.fullName ?<Text style={{marginTop:"5%",color:"red"}}>{props.errors.fullName}</Text>:null}
      ...
      <View>
        ...
        <View style={[styles.input, { width: "100%" }]}>
      <PhoneIcon height={20} width={20}style={{marginRight:"5%",color:"#BDBDBD"}} />
      <TextInput
      ...
      {props.touched.phone && props.errors.phone ? <Text style={{marginTop:"5%",color:"red"}}>{props.errors.phone}</Text>:null}
      ...
      {props.touched.email && props.errors.email ? <Text style={{marginTop:"5%",color:"red"}}>{props.errors.email}</Text>:null}
      ...
      {props.touched.password && props.errors.password ? <Text style={{marginTop:"5%",color:"red"}}>{props.errors.password}</Text>:null}
      ...
      {props.touched.confirmPassword && props.errors.confirmPassword ? <Text style={{marginTop:"5%",color:"red"}}>{props.errors.confirmPassword}</Text>:null}
      ...
      <View style={{ alignItems: "center" ,marginBottom:"20%"}}>
        ...
        <Text style={{ textAlign: "center", color: colors.SECONDARY_COLOR,fontSize:11}}>
