...
export default function PropertyType({navigation}){
 ...
 //
    ...
    return (<View style={{marginTop:"10%"}}>
        ...
        <TouchableOpacity onPress={()=>{navigation.navigate('condoSearch')}} style={{borderRadius:20,backgroundColor:"#6FCF97",paddingVertical:10,paddingHorizontal:20,justifyContent:"center",alignItems:"center",alignSelf:"center",marginTop:"10%",width:120}}><Text style={{color:"#ffffff",fontFamily:"Poppins-Medium"}}>Condo</Text></TouchableOpacity>
